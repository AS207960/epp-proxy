...
router!(
    ...
    EURIDHitPoints,         super::eurid::HitPointsRequest,             super::eurid::HitPointsResponse,         super::eurid::handle_hit_points,          super::eurid::handle_hit_points_response;
    EURIDRegistrationLimit, super::eurid::RegistrationLimitRequest,     super::eurid::RegistrationLimitResponse, super::eurid::handle_registration_limits, super::eurid::handle_registration_limits_response;
    EURIDDNSSECEligibility, super::eurid::DNSSECEligibilityRequest,     super::eurid::DNSSECEligibilityResponse, super::eurid::handle_dnssec_eligibility,  super::eurid::handle_dnssec_eligibility_response;
    EURIDDNSQuality,        super::eurid::DNSQualityRequest,            super::eurid::DNSQualityResponse,        super::eurid::handle_dns_quality,         super::eurid::handle_dns_quality_response
);
