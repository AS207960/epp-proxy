...
async fn main() {
    ...
    let conf_file_1_path = matches.value_of("acct1").unwrap();
    let conf_file_2_path = matches.value_of("acct2").unwrap();
    ...
    let epp_client_1 = epp_proxy::create_client(log_dir_1, &conf_1, &pkcs11_engine, false).await;
