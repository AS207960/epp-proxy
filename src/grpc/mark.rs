...
impl TryFrom<epp_proto::marks::Mark> for client::mark::Mark {
    type Error = tonic::Status;

    fn try_from(res: epp_proto::marks::Mark) -> Result<Self, Self::Error> {
        Ok(match res.mark {
            Some(epp_proto::marks::mark::Mark::Trademark(m)) => {
                client::mark::Mark::TradeMark(client::mark::TradeMark {
                    id: m.id,
            ...
            Some(epp_proto::marks::mark::Mark::TreatyOrStatute(m)) => {
                client::mark::Mark::TreatyOrStatute(client::mark::TreatyOrStatute {
                    id: m.id,
                    mark_name: m.mark_name,
                    holders: m
                        .holders
            ...
            Some(epp_proto::marks::mark::Mark::Court(m)) => {
                client::mark::Mark::Court(client::mark::Court {
                    id: m.id,
                    mark_name: m.mark_name,
                    holders: m
                        .holders
...
impl From<client::mark::Mark> for epp_proto::marks::Mark {
    fn from(res: client::mark::Mark) -> Self {
        epp_proto::marks::Mark {
            mark: Some(match res {
                client::mark::Mark::TradeMark(m) => {
                    epp_proto::marks::mark::Mark::Trademark(epp_proto::marks::TradeMark {
                        id: m.id,
                        mark_name: m.mark_name,
...
impl TryFrom<epp_proto::marks::Holder> for client::mark::Holder {
    type Error = tonic::Status;

    fn try_from(from: epp_proto::marks::Holder) -> Result<Self, Self::Error> {
        Ok(client::mark::Holder {
            name: from.name,
            organisation: from.organisation,
            address: match from.address {
                Some(a) => a.into(),
                None => return Err(tonic::Status::invalid_argument("address must be specified")),
            },
...
impl From<client::mark::Holder> for epp_proto::marks::Holder {
    fn from(from: client::mark::Holder) -> Self {
        epp_proto::marks::Holder {
            name: from.name,
            organisation: from.organisation,
            ...
            entitlement: match from.entitlement {
                client::mark::Entitlement::Owner => epp_proto::marks::Entitlement::Owner.into(),
                client::mark::Entitlement::Licensee => {
                    epp_proto::marks::Entitlement::Licensee.into()
                }
                client::mark::Entitlement::Assignee => {
                    epp_proto::marks::Entitlement::Assignee.into()
                }
            },
        }
    }
...
impl TryFrom<epp_proto::marks::Contact> for client::mark::Contact {
    type Error = tonic::Status;

    fn try_from(from: epp_proto::marks::Contact) -> Result<Self, Self::Error> {
        Ok(client::mark::Contact {
            ...
            voice: match from.voice {
                Some(v) => v.into(),
                None => return Err(tonic::Status::invalid_argument("voice must be specified")),
            },
            fax: from.fax.map(Into::into),
            email: from.email,
...
impl From<client::mark::Contact> for epp_proto::marks::Contact {
    fn from(from: client::mark::Contact) -> Self {
        epp_proto::marks::Contact {
            name: from.name,
            organisation: from.organisation,
            address: Some(from.address.into()),
            ...
            contact_type: match from.contact_type {
                client::mark::ContactType::Owner => {
                    epp_proto::marks::ContactType::OwnerContact.into()
                }
                client::mark::ContactType::Agent => epp_proto::marks::ContactType::Agent.into(),
                client::mark::ContactType::ThirdParty => {
                    epp_proto::marks::ContactType::ThirdParty.into()
                }
            },
        }
    }
...
impl From<epp_proto::marks::Address> for client::mark::Address {
    fn from(from: epp_proto::marks::Address) -> Self {
        client::mark::Address {
...
impl From<client::mark::Address> for epp_proto::marks::Address {
    fn from(from: client::mark::Address) -> Self {
        epp_proto::marks::Address {
